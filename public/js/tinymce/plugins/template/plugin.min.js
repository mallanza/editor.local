...
// GPL override: set default license_key to 'gpl'
if (typeof tinymce !== 'undefined' && tinymce.EditorManager) {
    tinymce.EditorManager.defaultSettings = tinymce.EditorManager.defaultSettings || {};
    tinymce.EditorManager.defaultSettings.license_key = 'gpl';
}
